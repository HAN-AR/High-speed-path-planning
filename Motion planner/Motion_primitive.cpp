...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f1 << dot(x) == (1.00000000000000000000e+01*cos(theta)-sin(theta)*vy);
    acadodata_f1 << dot(y) == (1.00000000000000000000e+01*sin(theta)+cos(theta)*vy);
    acadodata_f1 << dot(theta) == r;
    acadodata_f1 << dot(delta) == omega;
    acadodata_f1 << dot(omega) == u;
    acadodata_f1 << dot(vy) == (((r+vy)/1.00000000000000000000e+01-delta)*(-6.30000000000000000000e+04)/7.20000000000000000000e+02*cos(delta)+(-5.30760000000000000000e+04)*(-6.85999999999999943157e-01*r+vy)/1.00000000000000000000e+01/7.20000000000000000000e+02-1.00000000000000000000e+01*r);
    acadodata_f1 << dot(r) == (((r+vy)/1.00000000000000000000e+01-delta)*(-6.30000000000000000000e+04)*2.01764705882352939764e-03*cos(delta)-(-5.30760000000000000000e+04)*(-6.85999999999999943157e-01*r+vy)/1.00000000000000000000e+01*2.01764705882352939764e-03);

    OCP ocp1(0, T);
    ocp1.minimizeMayerTerm(T);
    ocp1.subjectTo(acadodata_f1);
    ocp1.subjectTo(AT_START, vy == 0.00000000000000000000e+00);
    ...
    ocp1.subjectTo(AT_END, vy == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, r == 0.00000000000000000000e+00);
    ...
    ocp1.subjectTo((-2.00000000000000011102e-01) <= omega <= 2.00000000000000011102e-01);
    ocp1.subjectTo((-2.00000000000000000000e+01) <= u <= 2.00000000000000000000e+01);
    ocp1.subjectTo(1.00000000000000005551e-01 <= T <= 1.00000000000000000000e+01);
